...
1. 本项目仅供学习和研究用途，不得用于任何商业目的或非法用途。
2. 用户应自行承担使用本工具所产生的一切法律责任。下载的内容版权归原作者所有，请尊重版权。
3. 本工具不对用户下载内容的合法性、准确性负责，亦不承担因使用本工具而导致的任何直接或间接损失。
4. 使用本工具即表示您已阅读并同意上述条款。如不同意，请立即停止使用并删除本工具。
